...
CREATE VIEW [DBA].[vw_Agent_Job_Information]
...
CREATE VIEW [DBA].[vw_Agent_Job_LastRun_Info]
...
CREATE VIEW [DBA].[vw_Agent_Job_Sched_Info]
...
CREATE VIEW [DBA].[vw_Agent_Job_Step_Config_Info]
...
CREATE VIEW [DBA].[vw_Agent_Job_Step_LastRun_Info]
